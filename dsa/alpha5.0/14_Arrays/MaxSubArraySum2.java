...
public class MaxSubArraySum2 {
    public static void findMaxSubArraySum(int numbers[]){
        ...
        //loop for countning prefixsum
        for(int i = 0;i<numbers.length;i++){
            for(int j =i;j<numbers.length;j++){  // implementation is correct but uses a nested loop (O(n²)
                                                       // complexity), making it less efficient than the optimized O(n)
                ...
                System.out.print("Current Sum with Index "+i+" and "+j+" is :- "+currentSum+ "  ");
            }
