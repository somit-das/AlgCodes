...
int main(){
	...
	myLinkedList1->printList();
		...
		myLinkedList1->deleteNode(2);
	cout << " LL after delete Node() in middle : " << endl;
	myLinkedList1->printList();
	
	myLinkedList1->deleteNode(0);
	cout << " LL after delete Node() of first node : " << endl;
	myLinkedList1->printList();
	
	myLinkedList1->deleteNode(2);
	cout << " LL after delete Node() of last node : " << endl;
	myLinkedList1->printList();
